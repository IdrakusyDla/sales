        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    @php $activeGeneral = $generalSettings->firstWhere('is_active', true); @endphp

                    @if($activeGeneral)
                        <div class="bg-blue-50 rounded-xl p-3 mb-4 flex gap-6">
                            <div class="flex-1 text-center">
                                <p class="text-xs text-gray-600">KM/Liter</p>
                                <p class="text-lg font-bold text-blue-600">{{ number_format($activeGeneral->km_per_liter, 2) }}</p>
                            </div>
                            <div class="w-px bg-blue-200"></div>
                            <div class="flex-1 text-center">
                                <p class="text-xs text-gray-600">Harga/Liter</p>
                                <p class="text-lg font-bold text-blue-600">Rp {{ number_format($activeGeneral->fuel_price, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-4">
                            <div>
                                ...
                                <input type="number" name="km_per_liter" step="0.01" min="0.01" required
                                    value="{{ $activeGeneral->km_per_liter ?? '10' }}"
