            ...
            <form action="{{ route('finance.export.excel') }}" method="GET">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" name="date_from" value="{{ date('Y-m-01') }}" class="w-full border border-gray-300 rounded-xl p-3 text-sm focus:ring-indigo-500">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-2">Sampai Tanggal</label>
                        <input type="date" name="date_to" value="{{ date('Y-m-d') }}" class="w-full border border-gray-300 rounded-xl p-3 text-sm focus:ring-indigo-500">
                    </div>
                </div>
                    ...
                    <form action="{{ route('finance.export.excel') }}" method="GET">
                        ...
                        <div class="grid grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="date" name="date_from" value="{{ date('Y-m-01') }}" class="w-full border-gray-200 bg-gray-50 text-gray-800 rounded-xl p-4 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-shadow">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wider">Sampai Tanggal</label>
                                <input type="date" name="date_to" value="{{ date('Y-m-d') }}" class="w-full border-gray-200 bg-gray-50 text-gray-800 rounded-xl p-4 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-shadow">
                            </div>
                        </div>
