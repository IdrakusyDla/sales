    ...
    <div class="px-5 md:px-8 py-6 md:py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <form action="{{ route('it.settings.update') }}" method="POST" class="flex-1 flex flex-col justify-between">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Masa Simpan Foto (Bulan)</label>
                        <p class="text-xs text-gray-500 mb-2">Foto absen dan struk yang lebih lama dari masa simpan akan
                            dihapus
