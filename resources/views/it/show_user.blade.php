    ...
    <div class="px-5 py-6">
        ...
        <form action="{{ route('it.user.delete', $user->id) }}" method="POST" class="mb-6">
            ...
            <button type="submit"
                ...
                class="w-full bg-gray-800 text-white py-3 rounded-xl font-bold text-sm border-2 border-gray-900 flex items-center justify-center gap-2">
