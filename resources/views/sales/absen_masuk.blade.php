...
@section('content')
    <div class="px-5 md:px-8 py-6 md:py-8 md:bg-slate-50/50 md:min-h-screen">
        ...
        <div class="md:hidden mb-6">
            ...
            <p class="text-sm text-gray-600">Sebelum berangkat kerja, ambil foto selfie dan foto odometer kendaraan</p>
        </div>
        ...
        <form action="{{ route('sales.absen.masuk.store') }}" method="POST" id="form-absen-masuk" class="card-form">
            @csrf
    ...
    @section('scripts')
        <script>
            ...
            if (fuelEnabled) {
                ...
                const odoInput = document.getElementById('odometer_value');
                if (odoInput) odoInput.addEventListener('input', checkSubmit);
            }
        </script>
    @endsection
@endsection
