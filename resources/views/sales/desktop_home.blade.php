                    ...
                    @forelse($todayLogs as $dailyLog)
                        ...
                        @if ($dailyLog->hasEnded())
                            <div class="flex items-start gap-6 mb-8 group">
                                <div class="w-14 h-14 rounded-2xl bg-red-50 text-red-600 flex items-center justify-center shrink-0 border border-red-100 shadow-sm group-hover:scale-110 group-hover:bg-red-500 group-hover:text-white transition-all">
                        ...
                        {{-- DAFTAR KUNJUNGAN --}}
                        <div class="space-y-6 relative before:absolute before:inset-0 before:ml-7 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-200 before:to-transparent mb-8">
                            @foreach($dailyLog->visits()->orderBy('time', 'desc')->get() as $item)
                                <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                                    <div class="w-14 h-14 rounded-full flex items-center justify-center shrink-0 border-4 border-white shadow-sm absolute left-0 md:left-1/2 md:-translate-x-1/2 bg-white z-10 transition-transform group-hover:scale-110
                                    ...
                                    <div class="bg-white p-5 rounded-2xl shadow-sm border hover:shadow-md transition ml-20 md:ml-0 md:w-[calc(50%-3rem)] 
                        ...
                        <div class="flex items-start gap-6 group">
                            <div class="w-14 h-14 rounded-2xl bg-green-50 text-green-600 flex items-center justify-center shrink-0 border border-green-100 shadow-sm group-hover:scale-110 group-hover:bg-green-500 group-hover:text-white transition-all">
                            ...
                            <div class="flex-1 bg-gray-50 rounded-2xl p-5 border border-gray-100">
                                ...
                                <p class="text-sm text-gray-600 flex items-center gap-2"><svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg> Plan: <span class="font-medium">{{ $dailyLog->daily_plan }}</span></p>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden transform transition hover:shadow-md">
                ...
                <div class="p-8 text-center">
                    <div class="w-24 h-24 rounded-full mx-auto flex items-center justify-center mb-6 shadow-md border-4 border-white ring-4 ring-gray-50
                        ...
                        @elseif($latestLog && !$latestLog->hasEnded()) bg-blue-600 text-white animate-pulse
                ...
                @else
                    <div class="bg-yellow-50 border-2 border-yellow-200 text-yellow-800 p-6 rounded-[2rem] text-center shadow-sm">
                        <div class="flex items-center justify-center gap-3 mb-3">
                            <div class="w-12 h-12 bg-yellow-200 text-yellow-700 rounded-full flex items-center justify-center animate-pulse">
