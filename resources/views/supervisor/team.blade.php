        ...
        <div class="mb-5">
            <div class="flex items-start justify-between gap-3">
                ...
                <a href="{{ route('supervisor.dashboard') }}"
                    class="shrink-0 inline-flex items-center gap-1.5 bg-gray-100 text-gray-700 text-xs font-bold px-3 py-2 rounded-xl active:scale-95 transition">
                ...
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="px-8 pt-8 pb-5">
                        <div class="flex items-center justify-between mb-1">
                            <div>
                                <h1 class="text-xl font-extrabold text-gray-800">Daftar Karyawan</h1>
                                <p class="text-sm text-gray-500 mt-1">Monitor absensi & aktivitas tim sales</p>
                            </div>
                            <a href="{{ route('supervisor.dashboard') }}"
                                class="inline-flex items-center gap-2 bg-gray-100 text-gray-700 text-xs font-bold px-4 py-2.5 rounded-xl hover:bg-gray-200 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                Aktivitas Terbaru
                            </a>
                        </div>
