...
@section('content')
    <div class="px-5 md:px-8 py-6 md:py-8">
        ...
        <div class="md:hidden bg-blue-50/50 rounded-2xl p-5 border border-blue-100 mb-6">
            ...
            <form method="GET" action="{{ route('supervisor.show.sales', $sales->id) }}">
