...
@section('content')
    <div class="px-5 md:px-8 py-6 md:py-8">
        ...
        <form action="{{ route('hrd.sales.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Jika dipilih, sales akan ditugaskan ke supervisor tersebut</p>
            </div>

            <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                <p class="text-xs text-blue-800">
                    <strong>Password default:</strong> sales123<br>
                    Sales dapat mengganti password setelah login pertama kali.
                </p>
            </div>
