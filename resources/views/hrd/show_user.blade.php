...
@section('content')
    <div class="px-5 md:px-8 py-6 md:py-8">
        ...
        <div class="flex flex-col xl:grid xl:grid-cols-4 gap-6 mb-6 xl:items-start">
            
            {{-- KOLOM KIRI: FILTER TANGGAL (Desktop Kiri, Mobile Bawah) --}}
            <div class="order-3 xl:order-1 xl:col-span-1">
                <div class="bg-blue-50/50 rounded-2xl p-5 border border-blue-100 h-full">
                    ...
                    <form method="GET" action="{{ route('hrd.show.user', $user->id) }}">
                        <div class="space-y-3">
                            <div>
            ...
            {{-- KOLOM TENGAH: MANAJEMEN SUPERVISOR (Desktop Tengah, Mobile Tengah) --}}
            <div class="order-2 xl:order-2 xl:col-span-2">
            @if($user->role === 'sales')
                <div class="bg-indigo-50/50 rounded-2xl p-5 border border-indigo-100 h-full">
                    ...
                    <div class="space-y-2 mb-4">
                        ...
                        @empty
                            <div class="bg-white/50 border border-indigo-50 rounded-xl p-3 text-center">
                    ...
                    <form action="{{ route('hrd.add.supervisor', $user->id) }}" method="POST" class="flex gap-2">
                        @csrf
                        <select name="supervisor_id" class="flex-1 text-sm border-0 ring-1 ring-inset ring-indigo-200 focus:ring-2 focus:ring-indigo-600 rounded-xl p-3 block w-full bg-white shadow-sm" required>
                        ...
                        <button type="submit"
                            class="bg-indigo-600 text-white px-5 py-3 rounded-xl text-sm font-bold hover:bg-indigo-700 shadow-sm transition">
                            Tambah
                        </button>
                    </form>
                </div>
            ...
            <div class="order-1 xl:order-3 xl:col-span-1 space-y-4">
