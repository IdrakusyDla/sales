...
<head>
    ...
    <style>
        ...
        @media (min-width: 768px) {
            ...
            /* Camera/video containers: center and constrain width */
            .desktop-main video,
            .desktop-main .h-\[50vh\] {
                max-width: 640px;
                margin-left: auto;
...
<body class="bg-gray-100 text-gray-800">
    ...
    {{-- ============================================ --}}
    {{-- MOBILE LAYOUT (<768px) — UNCHANGED --}} {{--============================================--}} <div
        class="md:hidden">
        <div class="max-w-[480px] mx-auto min-h-screen bg-white shadow-2xl relative overflow-hidden flex flex-col">
            ...
            <nav class="fixed left-1/2 transform -translate-x-1/2 w-full max-w-[480px] bg-white border-t border-gray-200 px-6 py-2 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]"
        ...
        {{-- ============================================ --}}
        {{-- DESKTOP LAYOUT (≥768px) — NEW --}}
        {{-- ============================================ --}}
        <div class="hidden md:flex min-h-screen">

            {{-- SIDEBAR --}}
            <aside
                class="w-64 bg-white border-r border-gray-200 fixed top-0 left-0 h-screen flex flex-col shadow-sm z-40">
            ...
            {{-- MAIN CONTENT AREA --}}
            <main class="flex-1 ml-64 min-h-screen bg-gray-50 desktop-main">
                @if (session('success'))
                    <div class="bg-green-500 text-white p-3 text-center text-sm font-bold sticky top-0 z-30">
                        <svg class="w-5 h-5 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg> {{ session('success') }}
                    </div>
